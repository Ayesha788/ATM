...
if (pinAnswer.pin === myPin) {
    ...
    if (operationAns.operation === "withdraw") {
        ...
        if (amountAns.amount <= myBalance) {
            ...
            console.log(`Your current Balance amount is less than the withdrawal amount you entered. Kindly enter your withdrawal amount within ${myBalance}`);
        }
    }
    ...
    if (operationAns.operation === "fastCash") {
        ...
        if (fastCashAns.fastCash <= myBalance) {
            ...
            console.log(`Your current Balance amount is less than the withdrawal amount you choosed. Kindly choose your withdrawal amount within ${myBalance}`);
        }
    }
}
else {
